...
import 'package:DeCarbon/ui/page/users/components/UsersRedeemDialog.dart';
...
class UsersCouponDetailsPage extends StatelessWidget {
  static const String PATH = '/users/coupon_details/:coupon_id';

  final String couponId;

  const UsersCouponDetailsPage({
    Key key,
                          ...
                          child: RaisedButton(
                            ...
                            onPressed: (){
                              showDialog(
                                context: context, 
                                builder: (context){
                                  return UsersRedeemDialog(couponData: data);
                                }
                              );
                            },
                            child: Center(
